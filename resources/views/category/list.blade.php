            ...
            <table class="table table-report -mt-2">
                ...
                <tbody>
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a href="javascript:;" data-tw-toggle="modal"
                                        data-tw-target="#overlapping-modal-preview_{{ $category->id }}"
                    ...
                    <!-- BEGIN: Modal Content Edit-->
                        <div id="overlapping-modal-preview_{{ $category->id }}"  class="modal" tabindex="-1" aria-hidden="true">
                                ...
                                <form method="POST" action="{{ route('category.update' , $category->id) }}"  >
                                    ...
                                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                        ...
                                        <div class="col-span-12 sm:col-span-12">
                                            <input id="name" name="name" type="text" value="{{ $category->name }}" class="form-control" ></div>
                                        @error('name')
                                        ...
                                        <div class="col-span-12 sm:col-span-12"><label for="modal-form-2" class="form-label">Description</label></div>
                                        <div class="col-span-12 sm:col-span-12">
                                            <textarea name="description" id="modal-form-2" type="text" class="form-control"
                                               placeholder="description pour le produit" value="{{ $category->description }}"> {{ $category->description }}
                                            </textarea>
                                            @error('description')
                                                <div class="alert alert-danger-soft show flex items-center mb-2" role="alert">
                                                <i data-lucide="alert-octagon" class="w-6 h-6 mr-2"></i> {{ $message }}</div>
